...
extension FolderModelByIndex on IsarCollection<FolderModel> {
  ...
  FolderModel? getByIdSync(String id) {
  ...
  Future<List<FolderModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<FolderModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(FolderModel object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(FolderModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<FolderModel> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<FolderModel> objects, {bool saveLinks = true}) {
...
extension FolderModelQueryWhereSort
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhere> anyIsarId() {
...
extension FolderModelQueryWhere
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> isarIdNotEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> isarIdGreaterThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> isarIdLessThan(
      Id isarId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> idEqualTo(
      String id) {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQueryFilter
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> idContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> idMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: '',
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'id',
        value: '',
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> isarIdEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isarId',
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> isarIdLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> isarIdBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension FolderModelQuerySortBy
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByCoverImagePath() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQuerySortThenBy
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByCoverImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coverImagePath', Sort.asc);
    });
  }
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIsarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isarId', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIsarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQueryWhereDistinct
  ...
  QueryBuilder<FolderModel, FolderModel, QDistinct> distinctByCoverImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QDistinct> distinctById(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQueryProperty
  ...
  QueryBuilder<FolderModel, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isarId');
    });
  }

  QueryBuilder<FolderModel, String?, QQueryOperations>
  ...
  QueryBuilder<FolderModel, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
